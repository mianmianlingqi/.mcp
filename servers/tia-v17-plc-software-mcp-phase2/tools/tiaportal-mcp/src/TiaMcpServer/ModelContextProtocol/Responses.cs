...
namespace TiaMcpServer.ModelContextProtocol
{
    ...
    public class DbMemberInfo
    {
        ...
        public IEnumerable<DbMemberInfo>? Children { get; set; }
    }

    public class ResponseDbMembers : ResponseMessage
    {
        public string? ObjectKind { get; set; }
        public string? ObjectPath { get; set; }
        public string? TypeName { get; set; }
        public IEnumerable<DbMemberInfo>? Members { get; set; }
    }
    ...
    public class ResponsePlcMigrationBundle : ResponseMessage
    {
        public bool? Ok { get; set; }
        public string? OutputDirectory { get; set; }
        public string? BlocksDirectory { get; set; }
        public string? TagTablesDirectory { get; set; }
        public string? ManifestPath { get; set; }
        public int? ExportedBlockCount { get; set; }
        public int? ExportedTagTableCount { get; set; }
        public IEnumerable<string>? ExportedBlocks { get; set; }
        public IEnumerable<string>? ExportedTagTables { get; set; }
        public IEnumerable<ImportFailure>? Failed { get; set; }
    }
